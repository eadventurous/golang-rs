...
mod impls {
    ...
    impl Syntax {
        ...
        pub fn rule_1(&mut self, (x, y, z): (usize, usize, usize)) {
...
mod tests {
    ...
    fn test_ebnf_repeated_needs_group() {
        ...
        assert_eq!(syntax.rules, vec![rule_A, rule_X0, rule_X1]);
    }

    #[test]
    fn test_ebnf_grouped() {
        let source = r#" <A> ::= ( "E" ) "#;
        let syntax = bnf(source);
